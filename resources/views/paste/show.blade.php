...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                        <div class="mt-2 flex items-center text-sm text-gray-500">
                            ...
                            Language: {{ $paste->formatted_language }}
                        </div>
        ...
        <div class="bg-gray-50">
            ...
            <pre><code id="paste-content" class="hljs language-{{ $paste->language === 'text' ? 'plaintext' : ($paste->language ?: 'plaintext') }} !p-6 !bg-white !text-sm !leading-relaxed !whitespace-pre-wrap !break-words !border-0 !rounded-none">{{ $paste->content }}</code></pre>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add line numbers using the plugin API
    document.querySelectorAll('pre code.hljs').forEach(function(block) {
        if (typeof hljs.lineNumbersBlock === 'function') {
            hljs.lineNumbersBlock(block);
        } else {
            console.warn('Line numbers plugin not loaded');
        }
    });
    ...
    style.textContent = `
        ...
        .hljs {
            ...
            font-family: ui-monospace, SFMono-Regular, "Menlo", "Monaco", "Cascadia Code", "Segoe UI Mono", "Roboto Mono", "Oxygen Mono", "Ubuntu Monospace", "Source Code Pro", "Fira Mono", "Droid Sans Mono", "Courier New", monospace !important;
